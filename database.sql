...
CREATE DATABASE  `Learning` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_cs ;
USE `Learning` ;

-- -----------------------------------------------------
-- Table `Learning`.`Offices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`Offices` (
...
-- -----------------------------------------------------
-- Table `Learning`.`Employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`Employees` (
  ...
  CONSTRAINT `fk_Employees_Employees`
    ...
    REFERENCES `Learning`.`Employees` (`employeeNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Employees_Offices`
    FOREIGN KEY (`officeCode`)
    REFERENCES `Learning`.`Offices` (`officeCode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`Customers` (
...
-- -----------------------------------------------------
-- Table `Learning`.`ProductLines`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`ProductLines` (
...
-- -----------------------------------------------------
-- Table `Learning`.`Products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`Products` (
  ...
  CONSTRAINT `fk_Products_ProductLines`
    ...
    REFERENCES `Learning`.`ProductLines` (`productLine`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `Learning`.`Orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`Orders` (
  ...
  CONSTRAINT `fk_Orders_Customers`
    ...
    REFERENCES `Learning`.`Customers` (`customerNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `Learning`.`OrderDetails`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`OrderDetails` (
  `orderNumber` INT(11) NOT NULL,
  `productCode` VARCHAR(15) NOT NULL,
  ...
  CONSTRAINT `fk_OrderDetails_Products`
    ...
    REFERENCES `Learning`.`Products` (`productCode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_OrderDetails_Orders`
    FOREIGN KEY (`orderNumber`)
    REFERENCES `Learning`.`Orders` (`orderNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `Learning`.`Payments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Learning`.`Payments` (
